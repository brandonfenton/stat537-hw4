...
```{r p1_a, echo=F, comment=NA, message=F, warning=F, fig.width=15, fig.height=12, out.width="\\linewidth", out.height="0.75\\linewidth", fig.cap="Pairwise bagplots", cache=T}
require(aplpack)
...
Denver is at the lower bound of the observed values of PDNFRSTAFF; however none of these institutions appear to be outliers in any single variable so they would not have been discovered as possible outliers had we not examined the pairwise plots.
...
```{r p3_a, echo=F, comment=NA, message=F, warning=F, out.width="\\linewidth", out.height="0.5\\linewidth", fig.width=14, fig.height=7, fig.align="center", fig.cap="All pairwise correlations"}
require(corrplot)
...
plot(predict(pcs)[,1:2], col=cc2015Rs$BASIC2015, pch=as.numeric(cc2015Rs$BASIC2015))
```
...
pcpcs <- prcomp(cor(cc2015percap_rank))
