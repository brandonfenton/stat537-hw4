...
```{r p6_a, echo=F, comment=NA, message=F, warning=F, out.width="\\linewidth", out.height="\\linewidth", fig.width=12, fig.height=12}
#something weird going on here
pc.scores <- as.matrix(cc2015Rs_2) %*% predict(pcs)[,1:2]
score.col <- as.numeric(cc2015Rs$BASIC2015)
score.pch <- score.col
score.col[which(cc2015Rs$NAME=="Montana State University")] <- 4
score.pch[which(cc2015Rs$NAME=="Montana State University")] <- 16
plot(pc.scores, col=score.col, pch=as.numeric(cc2015Rs$BASIC2015))
