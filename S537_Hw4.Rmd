...
```{r p5_a, echo=F, comment=NA, message=F, warning=F, out.width="0.4\\linewidth", out.height="0.4\\linewidth", fig.width=6, fig.height=6, fig.cap="Biplot of the first two PCs", fig.align="center", fig.pos="H"}
biplot(pcs)
```
