...
UC Denver and Rockefeller University are potential outliers in STEM\_RSD and PDNFRSTAFF.
...
CUNY Graduate School is a potential outlier in STEM\_RSD and S.ER.D.
```{r p1_c, echo=F, comment=NA, message=F, warning=F}
cc2015Rs[(cc2015Rs_2$STEM_RSD>200 & cc2015Rs_2$S.ER.D<50), c(1, 8, 10)]
```

UC Denver is also potentially an outlier in PDNFRSTAFF and S.ER.D.
