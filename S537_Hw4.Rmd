...
legend(x=max(pc.scores[,1])*0.7, y=min(pc.scores[,2])*0.55,
...
biplot(pcpcs, xlim = c(-0.15, 0.2), col =  c("#00000040", "#ff0000ff"))
```
...
plot(x=pc.scores[,1], y=pcpc.scores, col = score.col2, pch=score.pch2, ylab="First aggregate PC",
     xlab = "First per capita PC")

legend(x=max(pc.scores[,1])*0.7, y=max(pcpc.scores*0.98),
