...
PC1 is a weighted average of all on the variables. PC2 is __OTHER\_RSD__, and PC3 is a weighted average of __HUM\_RSD__ and __SOCSC\_RSD__ contrasted with a weighted average of __NONS.ER.D__ and __OTHER\_RSD__.
...
```{r p5_a, echo=F, comment=NA, message=F, warning=F, out.width="0.6\\linewidth", out.height="0.4\\linewidth", fig.width=9, fig.height=6, fig.cap="Biplot of the first two PCs", fig.align="center", fig.pos="H"}
biplot(pcs, xlim = c(-0.15, 0.2), col =  c("#00000040", "#ff0000ff"))
```
